            ...
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding:0 0 20px 0;" class="responsive-table">
                ...
                <tr>
                    ...
                    <td style="padding: 40px 0 0 0;" class="no-padding">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <tr>
                                <td align="left" style="padding: 0 0 5px 25px; font-size: 22px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding-copy">Cash on Delivery - COD</td>
                            </tr>
                            <tr>
                                 <td align="left" style="padding: 10px 0 15px 25px; font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Kamu dapat membayar secara langsung di <b>Stand Pendaftaran</b> kami atau <b>Camp Doscom</b> di gedung D, lantai 1, Universitas Dian Nuswantoro, Semarang. </td>
                            </tr>
                            <tr>
                                 <td align="left" style="padding: 10px 0 15px 25px; font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Tidak tau tempatnya ?</td>
                            </tr>
                            <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 40px 0 0 0;" class="no-padding">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                      <tr>
                                <td align="left" style="padding: 0 0 5px 25px; font-size: 22px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding-copy">Transfer via Rekening Bank</td>
                            </tr>
                            <tr>
