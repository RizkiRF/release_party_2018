                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#ffffff" width="400" align="right" class="mobile-hide">
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="right" style="padding: 0 0 5px 0; font-size: 14px; font-family: Arial, sans-serif; color: #666666; text-decoration: none;"><span style="color: #666666; text-decoration: none;">Terimakasih, {{ $nama }}</span></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                              <td>
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                          <td align="center" bgcolor="#ffffff" valign="middle"><a href="http://tealinuxos.org" target="_blank"><img src="http://4.bp.blogspot.com/-EbQ1M6OD5mE/VVVAR3XpSbI/AAAAAAAAAPQ/t2pdqljMomU/s1600/tealinuxos2.png" width="50" height="50" style="display: block; color: #666666; font-family: Helvetica, arial, sans-serif; font-size: 13px; width: 150px; height: 150px;" alt="Fluid images" border="0" class="img-max"></a></td>
                                      </tr>
                                      ...
                                      <tr>
                                          <td>
                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  ...
                                                  <tr>
                                                      <td align="center" style="font-size: 30px; font-family: Helvetica, Arial, sans-serif; color: #4EAE49;; padding-top: 30px;" class="padding-copy">{{ $kode_tiket . $kunci_rahasia }}</td>
                                                  </tr>
                                                  <tr>
                                                  ...
                                                  <tr>
                                                      <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Simpan QR-Code ini sebagai tiket masuk saat acara nanti. Jadi kamu tidak perlu mencetak QR-code ini, cukup tunjukan saja saat acara nanti. (Paperless ya :D)</td>
                                                  </tr>
                                      ...
                                      <tr>
                                          <td align="center" style="padding: 5px 0 0 0; font-size: 14px; line-height: 20px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Pastikan informasi tersebut benar, terutama nama, karena akan kami cetak di sertifikat. Jika ingin mengganti silahkan langsung hubungi kami via sms / email.</td>
                                      </tr>
                                  </table>
                              </td>
                          </tr>
    ...
    <tr>
        <td bgcolor="#f8f8f8" align="center" style="padding: 70px 15px 70px 15px;" class="section-padding">
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding:0 0 20px 0;" class="responsive-table">
                    ...
                    <td align="left" style="padding: 0 0 10px 0px; font-size: 25px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding-copy" colspan="2">Bingung atau ada pertanyaan ? </td>
                </tr>
                <tr>
                        ...
                        <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                            <tr>
                                <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                    <span class="appleFooter" style="color:#666666;">Gedung D, lantai 1, Universitas Dian Nuswantoro, Semarang.</span><br><a class="original-only" style="color: #666666; text-decoration: none;">Make with love by Doscom </a><span class="original-only" style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span><a style="color: #666666; text-decoration: none;">Dinus Open Source Commmunity</a>
                                </td>
                            </tr>
                        </table>
                    </td>
